...
export default function Home() {
  ...
  const experienceInfo = getExperienceInfo(language)
  const technicalSkills = getTechnicalSkillsInfo(language)
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <AnimatedSection animation="slide-right" delay={100}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">{t("skills.design")}</h4>
                    ...
                    <AnimatedSection animation="slide-left" delay={200}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">{t("skills.development")}</h4>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <AnimatedSection animation="slide-right" delay={300}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">{t("skills.uxMethods")}</h4>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <AnimatedSection animation="slide-left" delay={400}>
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-zinc-400">{t("skills.softSkills")}</h4>
                        <div className="flex flex-wrap gap-2">
