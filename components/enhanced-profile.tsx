...
export function EnhancedProfile() {
  ...
  const aboutInfo = getAboutInfo(language)
          ...
          <TabsContent value="contact" className="p-4 sm:p-6 space-y-4 focus:outline-none">
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium">{contactLabels.email}</h4>
                  <a
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium">{contactLabels.phone}</h4>
                  <a
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium">{contactLabels.location}</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium">{contactLabels.workingHours}</h4>
          ...
          <div className="flex items-center">
            ...
            <span className="text-xs text-zinc-400">
              {personalInfo.availableForWork
                ...
                : (language === "vi" ? "Không sẵn sàng nhận việc" : "Not available for new projects")}
            </span>
          </div>
        </div>
      </CardContent>
